...
- Statistic analysis
  -- Statistic analysis on the tweets, like most-used languages on Twitter posed inside U.S., the average length of each tweet for each state, frequency analysis on hashtag, emoji.
- Baseline Modeling:
